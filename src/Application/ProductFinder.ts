...
export class ProductFinder {
  constructor(private pageFetcher: PageFetcher, private productParser: ProductParser, private paginator: Paginator, private broker: DirectBroker) {}
  ...
  async start() {
    try {
      ...
      do {
        const page = await this.pageFetcher.getPage(this.paginator.limit, this.paginator.getOffset(), this.paginator.getPage());
